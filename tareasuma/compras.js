...
function mostrarMenu() {
    ...
    menu += (productos.length + 2) + ". Agregar objetos al carro de compras\n";
    menu += (productos.length + 3) + ". Salir\n";
    return menu;
}

function agregarCarroCompras(){


    let objeto = prompt("ingresa el objeto a agregar:");
    let precio = parseInt(prompt("precio del objeto"));

    productos.unshift({ nombre: objeto, precio: precio });
